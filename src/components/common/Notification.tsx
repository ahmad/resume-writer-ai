...
const NotificationItem: React.FC<NotificationProps> = React.memo(({
  id,
  type,
  title,
  message,
...
const NotificationContainer: React.FC = () => {
  const { state, hideNotification } = useUIState();
...
// Client wrapper component for use in server components
export const ClientNotificationContainer: React.FC = () => {
